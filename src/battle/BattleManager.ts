...
export class BattleManager implements BattleModule {
    ...
    private getDefaultPosition(team: 1 | 2, index: number): { row: number; col: number } {
    ...
    private convertBattleUnitToGameUnit(battleUnit: BattleUnit, position: { row: number; col: number }): Unit {
        return {
