...
export class GameLoop {
    ...
    private loop(timestamp: number): void {
        if (!this.isRunning || !this.canvasManager.ctx || !this.canvasManager.canvas) {
            return;
        }
        ...
        // Draw UI overlays
        this.inputManager.drawAttackMessage(this.canvasManager.ctx, this.canvasManager.canvas.width);
